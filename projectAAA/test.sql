...
INSERT INTO `user` VALUES (10000,'user','test2','user',112233,NULL,NULL),(10001,'user','test','user',112233,NULL,NULL);
...
CREATE TABLE `venue` (
  ...
  `password` varchar(30) DEFAULT NULL,
  `0-coordinate` varchar(50) DEFAULT NULL,
  `1-coordinate` varchar(50) DEFAULT NULL,
...
INSERT INTO `venue` VALUES (20000,'venue1',NULL,0,NULL,NULL,NULL,NULL),(20001,'venue2',NULL,0,NULL,NULL,NULL,NULL),(20002,'venue3',NULL,0,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2021-06-07  3:40:29
